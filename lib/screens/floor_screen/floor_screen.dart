...
import 'package:restaurant_app_flutter/getx_model/floor_model.dart';
...
class _FloorScreenState extends State<FloorScreen> {
  ...
  final customerCourseController=Get.find<CustomerCourseModel>();
  final floor=Get.put(FloorModel());
  int selectFloor = 0;
  int selectTable;
          ...
          children: [
            Container(
              padding: EdgeInsets.symmetric(
                  vertical: width * 0.01, horizontal: width * 0.014),
              child: Row(
                ...
                children: [
                  ...
                  Expanded(child: Container(
                      child: Center(child: Text("Table", style: TextStyle(
                          color: Colors.red, fontSize: width * 0.026),)))),
                  Text(
                    "Reservation Edit", style: TextStyle(color: Colors.red,),),
                ],
              ),
            ),
            // TODO Tables
                          ...
                          children: [
                            Container(
                              ...
                              child: GridView.count(
                                  ...
                                  children: List.generate(logic.floor[logic.selectedFloor.value].table.length, (index) {
                                    return InkWell(
                                      onTap: () {
                                        customerCourseController.tableNumber.value="F ${logic.selectedFloor} T $index";
                                        logic.selectedTable.value = index;
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: logic.floor[logic.selectedFloor.value].table[index].status == "1"
                                              ? Colors.green
                                              :logic.floor[logic.selectedFloor.value].table[index].status =="2"?Colors.blue: Colors.red,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FittedBox(
                                              child: Text(
                                                "${logic.floor[logic.selectedFloor.value].table[index].name} $index",
                                                style: TextStyle(
                            ...
                            ClipRRect(
                              ...
                              child: Container(
                                ...
                                child: ListView.separated(
                                    ...
                                    itemCount: logic.floor.value.length,
                                    itemBuilder: (context, index) {
                                      return InkWell(
                                        onTap: () {
                                          logic.selectedFloor.value = index;

                                        },
                                        child: Container(
                                          color: logic.selectedFloor.value == index ? Colors
                                              .grey : Colors.white,
                                          padding: EdgeInsets.symmetric(
                                              horizontal: width * 0.02),
                                          child: Row(
                    ...
                    Container(
                      ...
                      child: GridView.count(crossAxisCount: 3,
                        ...
                        children: List.generate(12, (index) =>
                            InkWell(
                              onTap: () {
                                Provider.of<InputManagerModel>(
                                    context, listen: false).addGuest(
                                    index > 8 ? index == 9 ? "C" : (index - 1)
